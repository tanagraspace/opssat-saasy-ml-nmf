...
public class MCServicesHelper {
    ...
    private static final ObjectType alertIdentityObjType
            = new ObjectType(AlertDefinitionDetails.AREA_SHORT_FORM,
                    AlertDefinitionDetails.SERVICE_SHORT_FORM,
                    AlertDefinitionDetails.AREA_VERSION,
                    new UShort(ALERT_IDENTITY_OBJECT_NUMBER));
    private static final ObjectType alertDefObjType
            = new ObjectType(AlertDefinitionDetails.AREA_SHORT_FORM,
                    AlertDefinitionDetails.SERVICE_SHORT_FORM,
                    AlertDefinitionDetails.AREA_VERSION,
                    new UShort(ALERT_DEFINITION_OBJECT_NUMBER));
    private static final ObjectType alertEventObjType
            = new ObjectType(AlertEventDetails.AREA_SHORT_FORM,
                    AlertEventDetails.SERVICE_SHORT_FORM,
                    AlertEventDetails.AREA_VERSION,
                    new UShort(ALERT_EVENT_OBJECT_NUMBER));

    // action objects
    private static final ObjectType actionIdentityObjType
            = new ObjectType(ActionDefinitionDetails.AREA_SHORT_FORM,
                    ActionDefinitionDetails.SERVICE_SHORT_FORM,
                    ActionDefinitionDetails.AREA_VERSION,
                    new UShort(ACTION_IDENTITY_OBJECT_NUMBER));

    private static final ObjectType actionDefObjType
            = new ObjectType(ActionDefinitionDetails.AREA_SHORT_FORM,
                    ActionDefinitionDetails.SERVICE_SHORT_FORM,
                    ActionDefinitionDetails.AREA_VERSION,
                    new UShort(ACTION_DEFINITION_OBJECT_NUMBER));

    private static final ObjectType actionInstanceObjType
            = new ObjectType(ActionInstanceDetails.AREA_SHORT_FORM,
                    ActionInstanceDetails.SERVICE_SHORT_FORM,
                    ActionInstanceDetails.AREA_VERSION,
                    new UShort(ACTION_INSTANCE_OBJECT_NUMBER));
    ...
    //group objects
    private static final ObjectType groupIdentityType
            = new ObjectType(GroupDetails.AREA_SHORT_FORM,
                    GroupDetails.SERVICE_SHORT_FORM,
                    GroupDetails.AREA_VERSION,
                    new UShort(GROUP_IDENTITY_OBJECT_NUMBER));

    private static final ObjectType groupDefinitionObjType
            = new ObjectType(GroupDetails.AREA_SHORT_FORM,
                    GroupDetails.SERVICE_SHORT_FORM,
                    GroupDetails.AREA_VERSION,
                    new UShort(GROUP_DEFINITION_OBJECT_NUMBER));

    //activity objects
    private static final ObjectType operationActivityObjType
            = new ObjectType(OperationActivity.AREA_SHORT_FORM,
                    OperationActivity.SERVICE_SHORT_FORM,
                    OperationActivity.AREA_VERSION,
                    new UShort(OPERATION_ACTIVITY_OBJECT_NUMBER));

    private static final ObjectType activityReleaseObjType
            = new ObjectType(ActivityTransfer.AREA_SHORT_FORM,
                    ActivityTransfer.SERVICE_SHORT_FORM,
                    ActivityTransfer.AREA_VERSION,
                    new UShort(ACTIVITY_RELEASE_OBJECT_NUMBER));

    private static final ObjectType activityAcceptanceObjType
            = new ObjectType(ActivityAcceptance.AREA_SHORT_FORM,
                    ActivityAcceptance.SERVICE_SHORT_FORM,
                    ActivityAcceptance.AREA_VERSION,
                    new UShort(ACTIVITY_ACCEPTANCE_OBJECT_NUMBER));

    private static final ObjectType activityExecutionObjType
            = new ObjectType(ActivityExecution.AREA_SHORT_FORM,
                    ActivityExecution.SERVICE_SHORT_FORM,
                    ActivityExecution.AREA_VERSION,
                    new UShort(ACTIVITY_EXECUTION_OBJECT_NUMBER));

    //conversion objects
    private static final ObjectType conversionIdentityObjType
            = new ObjectType(DiscreteConversionDetails.AREA_SHORT_FORM,
                    DiscreteConversionDetails.SERVICE_SHORT_FORM,
                    DiscreteConversionDetails.AREA_VERSION,
                    new UShort(CONVERSION_IDENTITY_OBJECT_NUMBER));

    private static final ObjectType discreteConversionObjType
            = new ObjectType(DiscreteConversionDetails.AREA_SHORT_FORM,
                    DiscreteConversionDetails.SERVICE_SHORT_FORM,
                    DiscreteConversionDetails.AREA_VERSION,
                    new UShort(DISCRETE_CONVERSION_OBJECT_NUMBER));

    private static final ObjectType lineConversionObjType
            = new ObjectType(LineConversionDetails.AREA_SHORT_FORM,
                    LineConversionDetails.SERVICE_SHORT_FORM,
                    LineConversionDetails.AREA_VERSION,
                    new UShort(LINE_CONVERSION_OBJECT_NUMBER));

    private static final ObjectType polyConversionObjType
            = new ObjectType(PolyConversionDetails.AREA_SHORT_FORM,
                    PolyConversionDetails.SERVICE_SHORT_FORM,
                    PolyConversionDetails.AREA_VERSION,
                    new UShort(POLY_CONVERSION_OBJECT_NUMBER));

    private static final ObjectType rangeConversionObjType
            = new ObjectType(RangeConversionDetails.AREA_SHORT_FORM,
                    RangeConversionDetails.SERVICE_SHORT_FORM,
                    RangeConversionDetails.AREA_VERSION,
                    new UShort(RANGE_CONVERSION_OBJECT_NUMBER));

    //statistic object
    private static final ObjectType statisticFunctionObjType
            = new ObjectType(StatisticFunctionDetails.AREA_SHORT_FORM,
                    StatisticFunctionDetails.SERVICE_SHORT_FORM,
                    StatisticFunctionDetails.AREA_VERSION,
                    new UShort(STATISTIC_FUNCTION_OBJECT_NUMBER));

    private static final ObjectType statisticLinkObjType
            = new ObjectType(StatisticLinkDetails.AREA_SHORT_FORM,
                    StatisticLinkDetails.SERVICE_SHORT_FORM,
                    StatisticLinkDetails.AREA_VERSION,
                    new UShort(STATISTIC_LINK_OBJECT_NUMBER));

    private static final ObjectType statisticLinkDefinitionObjType
            = new ObjectType(StatisticLinkDetails.AREA_SHORT_FORM,
                    StatisticLinkDetails.SERVICE_SHORT_FORM,
                    StatisticLinkDetails.AREA_VERSION,
                    new UShort(STATISTIC_LINK_DEFINITION_OBJECT_NUMBER));

    private static final ObjectType statisticValueInstanceObjType
            = new ObjectType(StatisticValue.AREA_SHORT_FORM,
                    StatisticValue.SERVICE_SHORT_FORM,
                    StatisticValue.AREA_VERSION,
                    new UShort(STATISTIC_VALUE_INSTANCE_OBJECT_NUMBER));
    
    //statistic function instance objects
    
    //parameter objects
    private static final ObjectType parameterIdentityObjType
            = new ObjectType(ParameterDefinitionDetails.AREA_SHORT_FORM,
                    ParameterDefinitionDetails.SERVICE_SHORT_FORM,
                    ParameterDefinitionDetails.AREA_VERSION,
                    new UShort(PARAMETER_IDENTITY_OBJECT_NUMBER));
    private static final ObjectType parameterDefinitionDetailsObjType
            = new ObjectType(ParameterDefinitionDetails.AREA_SHORT_FORM,
                    ParameterDefinitionDetails.SERVICE_SHORT_FORM,
                    ParameterDefinitionDetails.AREA_VERSION,
                    new UShort(PARAMETER_DEFINITION_OBJECT_NUMBER));
    private static final ObjectType parameterValueObjType
            = new ObjectType(ParameterValue.AREA_SHORT_FORM,
                    ParameterValue.SERVICE_SHORT_FORM,
                    ParameterValue.AREA_VERSION,
                    new UShort(PARAMETER_VALUE_INSTANCE_OBJECT_NUMBER));

    //check objects
    private static final ObjectType checkIdentityObjType
            = new ObjectType(CheckLinkDetails.AREA_SHORT_FORM,
                    CheckLinkDetails.SERVICE_SHORT_FORM,
                    CheckLinkDetails.AREA_VERSION,
                    new UShort(CHECK_IDENTITY_OBJECT_NUMBER));
    private static final ObjectType checkLinkObjType
            = new ObjectType(CheckLinkDetails.AREA_SHORT_FORM,
                    CheckLinkDetails.SERVICE_SHORT_FORM,
                    CheckLinkDetails.AREA_VERSION,
                    new UShort(CHECK_LINK_OBJECT_NUMBER));
    private static final ObjectType checkLinkDefinitionObjType
            = new ObjectType(CheckLinkDetails.AREA_SHORT_FORM,
                    CheckLinkDetails.SERVICE_SHORT_FORM,
                    CheckLinkDetails.AREA_VERSION,
                    new UShort(CHECK_LINK_DEFINITION_OBJECT_NUMBER));
    private static final ObjectType constantCheckObjType
            = new ObjectType(ConstantCheckDefinition.AREA_SHORT_FORM,
                    ConstantCheckDefinition.SERVICE_SHORT_FORM,
                    ConstantCheckDefinition.AREA_VERSION,
                    new UShort(CONSTANT_CHECK_OBJECT_NUMBER));
    private static final ObjectType referenceCheckObjType
            = new ObjectType(ReferenceCheckDefinition.AREA_SHORT_FORM,
                    ReferenceCheckDefinition.SERVICE_SHORT_FORM,
                    ReferenceCheckDefinition.AREA_VERSION,
                    new UShort(REFERENCE_CHECK_OBJECT_NUMBER));
    private static final ObjectType deltaCheckObjType
            = new ObjectType(DeltaCheckDefinition.AREA_SHORT_FORM,
                    DeltaCheckDefinition.SERVICE_SHORT_FORM,
                    DeltaCheckDefinition.AREA_VERSION,
                    new UShort(DELTA_CHECK_OBJECT_NUMBER));
    private static final ObjectType limitCheckObjType
            = new ObjectType(LimitCheckDefinition.AREA_SHORT_FORM,
                    LimitCheckDefinition.SERVICE_SHORT_FORM,
                    LimitCheckDefinition.AREA_VERSION,
                    new UShort(LIMIT_CHECK_OBJECT_NUMBER));
    private static final ObjectType compoundCheckObjType
            = new ObjectType(CompoundCheckDefinition.AREA_SHORT_FORM,
                    CompoundCheckDefinition.SERVICE_SHORT_FORM,
                    CompoundCheckDefinition.AREA_VERSION,
                    new UShort(COMPOUND_CHECK_OBJECT_NUMBER));
    private static final ObjectType checkTransitionObjType
            = new ObjectType(CheckResult.AREA_SHORT_FORM,
                    CheckResult.SERVICE_SHORT_FORM,
                    CheckResult.AREA_VERSION,
                    new UShort(CHECK_TRANSITION_OBJECT_NUMBER));
    
    //aggregation objects
    private static final ObjectType aggregationIdentityObjType
            = new ObjectType(AggregationDefinitionDetails.AREA_SHORT_FORM,
                    AggregationDefinitionDetails.SERVICE_SHORT_FORM,
                    AggregationDefinitionDetails.AREA_VERSION,
                    new UShort(AGGREGATION_IDENTITY_OBJECT_NUMBER));
    
    private static final ObjectType aggregationDefinitionObjType
            = new ObjectType(AggregationDefinitionDetails.AREA_SHORT_FORM,
                    AggregationDefinitionDetails.SERVICE_SHORT_FORM,
                    AggregationDefinitionDetails.AREA_VERSION,
                    new UShort(AGGREGATION_DEFINITION_OBJECT_NUMBER));    
    
    private static final ObjectType aggregationValueInstanceObjType
            = new ObjectType(AggregationDefinitionDetails.AREA_SHORT_FORM,
                    AggregationDefinitionDetails.SERVICE_SHORT_FORM,
                    AggregationDefinitionDetails.AREA_VERSION,
